...
<svg :class="sizeClass" viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
    <defs>
	...
	<g>
		<path d="M0,49.2 L43.6,0 L132.8,19.2 L144.8,55.6 L136,118.8 L100.537692,100.651642 L102.4,151.2 L102.4,195.2 L24.4,196 L0,49.2 Z" fill="url(#linearGradient-1)">
